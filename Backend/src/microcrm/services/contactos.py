...
def normalizar_email(email: str) -> str:
    ...
    `LUIS@nova.pe` y `luis@nova.pe` son el mismo buzon; normalizamos antes de
    buscar duplicados y guardamos esa misma version para que la base no
    termine con variantes de capitalizacion conviviendo como filas distintas.
    """
